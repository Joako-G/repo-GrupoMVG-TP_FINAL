...
//		assertEquals("HQ55022",pago5.getId().getNumeroCheque());
		...
		System.out.println("customer 1: "+ paymentService.existPaymentByCustomer(customer1.get().idCliente));
		Customer customer2 = new Customer();
		customer2.setIdCliente((long) 998);
		System.out.println("customer2: " + paymentService.existPaymentByCustomer(customer2.idCliente));
	}
