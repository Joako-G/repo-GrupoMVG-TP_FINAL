...
//		
//		Employee employee1 = new Employee(Integer.valueOf(1), "Murphy", "Diane", "x5800", "dmurphy@classicmodelcars.com", "President", oficina1.get(), null);
...
//		
//		Employee employee4 = new Employee(Integer.valueOf(4), "Patterson", "William", "x4871", "wpatterson@classicmodelcars.com", "Sales Manager (APAC)", oficina2.get(), employee2);
//		employeeService.guardarEmployee(employee4);
//		
//		Employee employee5 = new Employee(Integer.valueOf(5), "Bondur", "Gerard", "x5408", "gbondur@classicmodelcars.com", "Sale Manager (EMEA)", oficina3.get(), employee2);
...
//		assertEquals("4",oficina3.get().getId());
		...
		System.out.println(employeeService.existEmpleadoPorEmpleado(1002));
